  ...
  <div class="mg-l-20">
    ...
    <el-card shadow="none">
      <el-row>
        ...
        <el-col :span="11">
          <e-input
            v-model="user.vendor_info.contact_person"
            type="text"
        ...
        <el-col :offset="1" :span="11">
          <e-input
            v-model="user.vendor_info.contact_person_number"
            type="number"
            label="Phone Number"
        ...
        <el-col :span="11">
          <e-input
            v-model="user.vendor_info.gst_number"
            type="text"
            label="GST Number"
        ...
        <el-col :offset="1" :span="11">
          <e-input
            v-model="user.vendor_info.tin_number"
            type="text"
            label="Tin Number"
        ...
        <el-col :span="23">
          ...
          <textarea
            ...
            placeholder="LoreIpsum, sector 14, 131001, Sonipat,Harayana"
            rows="5"
            cols="128"
          />
        </el-col>
    ...
    <el-card shadow="none">
      <el-row>
        <el-col :span="11">
          <e-input
            v-model="user.vendor_info.bank_details.account_no"
            type="text"
        ...
        <el-col :span="11" :offset="1">
          <e-input
            v-model="user.vendor_info.bank_details.ifsc_code"
            type="text"
            label="IFSC Code"
          ></e-input>
        </el-col>
      ...
      <el-row class="mt10">
        <el-col :span="11">
          <e-input
            v-model="user.vendor_info.bank_details.bank_name"
            type="text"
            label="Bank Name"
        ...
        <el-col :span="11" :offset="1">
          <e-input
            v-model="user.vendor_info.bank_details.account_holder"
            type="text"
            label="Account Holder Name"
            placeholder="0121-288128"
          ></e-input>
        </el-col>
      </el-row>
    </el-card>
...
export default {
  ...
  methods: {
    ...
    save() {
      ...
      dispatchGraphql(this.userMutation, this.getUserVariables()).then(
        (response) => {
          console.log(response);
          dispatchGraphql(this.vendorMutation, this.getVendorVariables()).then(
            (response) => {
              console.log(response);
              dispatchGraphql(this.bankMutation, this.getBankVariables()).then(
                (response) => {
                  console.log(response);
                  this.$emit("save");
                }
