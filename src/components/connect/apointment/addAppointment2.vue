      ...
      <el-tab-pane v-if="verifyType('student')" label="Student" name="student">
        ...
        <el-row style="border-top: 1px solid #fcdfbd;margin-top: 20px;padding-bottom: 15px;">
          ...
          <el-col class="float-right" :span="10">
            <e-button :span="15" label="Cancel" width="180" css="cancel_btn" type="default" class="p-45" @click="setNextTab(activeName)" />
            <e-button :span="8" label="Next" width="180" css="float-right" class="p-45" @click="setNextTab(activeName)" />
          </el-col>
        </el-row>
        ...
        <el-row>
          ...
          <el-col :span="12">
            ...
            <el-row>
              <el-col :span="10">
                <el-card shadow="none" style="margin-right: 20px" class="rounded-08 elimeny" >
                  <div style="display: flex" @click="adminAudience()">
                    <e-svg style="margin-right: 10px" icon="AllStudents" />
                    All the Admins
                  </div>
                </el-card>
  ...
  methods: {
    ...
    handleCustomAudience() {
      if (this.activeName === 'student') {
        ...
        this.customAudience = []
        this.customAudience = this.admins
      }
      this.dialog = true
    },
    getAudience() {
    ...
    adminAudience() {
      ...
      console.log('adminaud', this.audience)
    },
