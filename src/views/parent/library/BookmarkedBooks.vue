<template>
  <div style="padding: 30px; height: 73vh; overflow: auto">
    ...
    >
      ...
      <el-col :span="2" style="color: #BC6C42;font-size:16px">Clear filter</el-col>
      <el-col style="padding-left: 10px" :offset="17" :span="1">
        <e-button
          icon="el-icon-search"
          :plain="true"
          css="bg-tranparent"
    ...
    >
    We have <b>60</b> bookmarked books for biology
