<template>
  <div>
    <e-container class="parent-appointment" pageTitle="Parent Appointments" btnIcon="el-icon-plus" btnText="New Appointment" @btnClick="$router.push('/connect/createstaff-apointment/parent')">
      <el-tabs class="floatTabHeader" v-model="activeName">
        ...
        <el-tab-pane label="Upcoming" name="Upcoming" class="connect-parent-appointment">
          <el-row>
            <el-col :span="3">
              <div style="color: #222222" class="fs-16 f-500">
        ...
        <el-tab-pane label="Past" name="Past" class="connect-parent-appointment">
          <el-row>
            <el-col :span="3">
              <div style="color: #222222" class="fs-16 f-500">
