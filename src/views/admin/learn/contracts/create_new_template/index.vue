<template>
  <div class="dashboard-editor-container contract">
    ...
    <div class="title bg-white pd-15">
      <div class="bg-white pd-x-40">
        <div class="hash-color-1 text-center">
          <el-row :gutter="20" class="row-text-display-center pointer">

            <!-- <el-col :xs="3" :sm="3" :md="3" :lg="3" :xl="3" class="tab" :class="{ active : activeTabElement == 1, tab_border : activeTabElement == 1 }" >
            ...
            <el-col :xs="3" :sm="3" :md="3" :lg="3" :xl="3" class="tab" :class="{ active : activeTabElement == 2, tab_border : activeTabElement == 2 }">
              <div class="coaching-program-hover pd-t-20">
                <div class="icon">
            ...
            <el-col :xs="3" :sm="3" :md="3" :lg="3" :xl="3" class="tab" :class="{ active : activeTabElement == 3, tab_border : activeTabElement == 3 }">
              <div class="coaching-program-hover pd-t-20">
                <div class="icon">
...
export default {
  name: 'SendContract',
  directives: {},
  components: {AddSignees, EditDocument, Preview },
  filters: {},
  props: {},
  data() {
    return {
