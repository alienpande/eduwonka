<template>
  <e-container class="learn-add-classroom" hideHeader pageTitle="Create a classroom" :back="$url.LN_CLASSROOM">
     <e-steps
      :steps="steps"
      :active="activeTab"
...
export default {
  ...
  methods: {
    getValue(value, value2) {
      this.scrollTop();
      this.tabOneData.standard_id = value
      this.tabOneData.classroom_id = value2
      this.activeTab = 2;
    },
