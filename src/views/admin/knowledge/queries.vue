<template>
  <div>
    <div class="knowledge-queries-head" style="background: white; padding: 50px 30px">
      <el-row>
        <el-col :span="4">
          <div style="opacity: 0.8; font-size: 24px; font-weight: 600">
            Queries
          </div>
        </el-col>
        <el-col :span="3" :offset="13">
          <e-button @click="postQuestion = true" :plain="true" label="Post query" />
        </el-col>
        <el-col :span="3">
          <e-button label="Tag Directory" />
        </el-col>
      </el-row>
    </div>
    <div class="main-body-fix"  style="padding: 25px; height: 55vh; overflow: auto">
      <el-row style="margin-left:20px">
        ...
        <el-col style="padding-left: 10px" :span="1">
          <e-button icon="el-icon-search" :plain="true" css="bg-tranparent" @click="tagQuery()" />
        </el-col>
      </el-row>
      <br />
      <el-card  style="width: 25rem;display: inline-block;margin-left: 20px;margin-bottom: 20px;" shadow="none" v-for="query in queries" :key="query.id">
      <div style="cursor:pointer" @click="favorate(query.id)">
        <el-row>
          <el-row>
            <el-col :span="20">
              <div @click="$router.push('/knowledge/queries-detail/' + query.id)">
                <el-col class="tx-overflow" style="color: #4d4f5c; font-weight: 500" >
                  {{ query.post }}
                </el-col>
              </div>
            </el-col>
    ...
    <post-question   :show="postQuestion"
