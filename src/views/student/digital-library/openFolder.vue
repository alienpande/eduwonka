<template>
  <es-container :pageTitle="folder.title" btnText2="New" :btnPlain2="true" @btnClick="addNew = true" class="bg-black-5">
    <el-row class="mg-l-15">
      <el-col class="mg-l-30" :span="3">
        <es-button text="Share Folder" @click="$router.push($url.DL_SHEARE_FOLDER + '/' + $route.params.id)" />
      </el-col>
