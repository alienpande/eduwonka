    ...
    <e-container hideHeader pageTitle="View Fee" :back="$url.FI_FEE_RECEIPTS">
              ...
              <el-col :span="16">
                <el-row>
                  <el-col :span="10">
                    ...
                    <div class="details-text">{{studentFeeDetails.student.first_name}}</div>

                    <div style="details-heading">Class</div>
                    <div class="details-text">{{studentFeeDetails.student.section.standard.name}}</div>

                    <div style="details-heading">Gender</div>
                    <div class="details-text">{{studentFeeDetails.student.gender}}</div>
                  </el-col>
                  <el-col :span="10" :offset="1">
                    <div style="details-heading">Admission Number</div>
                    <div class="details-text">{{studentFeeDetails.student.admission_number}}</div>

                    <div style="details-heading">Roll Number</div>
                    <div class="details-text">{{studentFeeDetails.student.roll_number}}</div>
                  </el-col>
                </el-row>
              </el-col>
            </el-row>
      ...
      <el-card shadow="none">
        <el-row>
          ...
          <el-col :span="4" >
            ...
            <br/>
            <div style="color: #000000CC;" class="details-text">{{studentFeeDetails.pay_type}}</div>
          </el-col>
        </el-row>
      </el-card>
      ...
      <el-card shadow="none" class="total-fees">
        <e-table :table="feeLineDetails" @pageInfo="ptest">
          ...
          <el-table-column label="Payable Amount" prop="default_amount">
          </el-table-column>
          <el-table-column label="Amount Paid" prop="paid_amount">
            <!-- <template slot-scope="scope">
              <input
                style="
          ...
          <el-table-column label="Due Amount(INR)" prop="Due">
            <template slot-scope="scope">
              {{setDueAmount(scope.row.default_amount, scope.row.paid_amount)}}
            </template>
          </el-table-column>
          <el-table-column style="width: 11rem" label="Due Amount of this term" prop="dueThisTerm">
             <template slot-scope="scope">
       ...
       <div style="color: #00000099;" class="fs-16 ">{{studentFeeDetails.remark}}</div>
      </el-card>
  ...
  methods: {
    ...
    getStudentFee() {
      ...
      dispatchGraphql(query).then((response) => {
        ...
        console.log("studentFeeDetails", this.studentFeeDetails)
